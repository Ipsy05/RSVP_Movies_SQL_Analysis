...
/* 4 columns in movie table have null values, the name of the columns are as follows
...
/* following are the number of movies released each year
- 2017 - 3052 movies
- 2018 - 2944 movies
- 2019 - 2001 movies
*/
...
-- Highest number of movies were released in March and the lowest number were released in the month of December
...
(
         ...
         FROM     genre
         GROUP BY genre
         ORDER BY movie_count DESC limit 3 ), top_5_movie AS
(
           SELECT     genre,
                      year,
                      title AS movie_name,
